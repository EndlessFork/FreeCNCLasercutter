...
// transmitting data
int8_t usb_serial_putchar(char c);    // transmit a character
int8_t usb_serial_putchar_nowait(char c);  // transmit a character, do not wait
...
// HID (human int16_terface device)
